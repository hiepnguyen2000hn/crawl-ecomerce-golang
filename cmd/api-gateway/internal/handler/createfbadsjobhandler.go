...
func CreateFbAdsJobHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateFbAdsJobRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewCreateFbAdsJobLogic(r.Context(), svcCtx)
		resp, err := l.CreateFbAdsJob(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
