...
func CreateAmazonJobHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateAmazonJobRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewCreateAmazonJobLogic(r.Context(), svcCtx)
		resp, err := l.CreateAmazonJob(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
