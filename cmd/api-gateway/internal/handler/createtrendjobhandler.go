...
func CreateTrendJobHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateTrendJobRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewCreateTrendJobLogic(r.Context(), svcCtx)
		resp, err := l.CreateTrendJob(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
