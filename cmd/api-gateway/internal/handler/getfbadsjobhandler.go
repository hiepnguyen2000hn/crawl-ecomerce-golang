...
func GetFbAdsJobHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetFbAdsJobRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewGetFbAdsJobLogic(r.Context(), svcCtx)
		resp, err := l.GetFbAdsJob(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
